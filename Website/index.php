...
<body>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-sm-4">
				<button class="btn btn-block btn-lg btn-info btnScenar">Expliquer à la caissière que vous avez oublié votre carte bleue dans la voiture.</button>
			</div>
			...
			<div class="col-sm-4">
				<button class="btn btn-block btn-lg btn-info btnScenar">Lol.</button>
			</div>
		</div>
		<br/>
	</div>
