...
<body class="content">
	...
	<div id="contenu" class="mw1600e pl2 pr2 content">
		<div class="main">
			<br/>
			<div id="rpg" class="row game p2">
				<h2>Scénario</h2>
				<div class="grid left w50 center aligncenter automobile autotablet">
					<img src="" alt="Image"></img>
				</div>
				<div class="grid left w50 justify automobile autotablet">
					<span>
						...
						Sed nisl erat, iaculis vel facilisis at, vehicula non augue. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Fusce ultrices dolor gravida sagittis gravida. Aliquam justo augue, ornare sed massa in, varius cursus nibh. Nam commodo ultricies tincidunt. Sed efficitur nulla a ornare facilisis. Duis vulputate erat nec nisi lacinia, et cursus tortor vulputate. Pellentesque id lacus sagittis, posuere purus sit amet, auctor neque. Etiam blandit libero viverra, viverra lectus id, pharetra massa. Proin diam justo, lobortis ac rutrum et, commodo ut neque. Nulla et luctus felis, id pellentesque nulla. Aenean turpis massa, tempor eu eros at, pretium blandit nunc. Morbi molestie arcu non urna scelerisque mollis.
					</span>
				</div>
			</div>
			...
			<div class="game nomobile notablet noprint">
				<div class="row center p2">
					<div class="grid left w33"><button class="btn">Expliquer à la caissière que vous avez oublié votre carte bleue dans la voiture.</button></div>
					<div class="grid left w33"><button class="btn">Expliquer à la caissière que vous avez oublié votre carte bleue dans la voiture.</button></div>
					<div class="grid left w33"><button class="btn">Expliquer à la caissière que vous avez oublié votre carte bleue dans la voiture.</button></div>
				</div>
			</div>
			...
			<div class="game nodesktop">
				<div class="row center p2">
					<div class="grid left w100"><button class="btn">Expliquer à la caissière que vous avez oublié votre carte bleue dans la voiture.</button></div>
					<div class="grid left w100"><button class="btn">Expliquer à la caissière que vous avez oublié votre carte bleue dans la voiture.</button></div>
					<div class="grid left w100"><button class="btn">Expliquer à la caissière que vous avez oublié votre carte bleue dans la voiture.</button></div>
				</div>
			</div>
