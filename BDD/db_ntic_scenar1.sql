...
--
-- Client :  127.0.0.1
-- Généré le :  Sam 21 Janvier 2017 à 09:13
...
(67, 51, 21, 'Expliquer que Emma est atteinte de PTSD', NULL, 1),
(68, 51, 21, 'Demander Ã  Emma de se concentrer', NULL, -3),
(69, 52, 21, 'Expliquer Ã  sa place', NULL, 2),
(70, 52, 21, 'Expliquer que Emma est atteinte de PTSD', NULL, 1),
(71, 52, 21, 'Demander Ã  Emma de se concentrer', NULL, -3),
(72, 53, 1, 'Recommencer ?', NULL, 0),
(73, 54, 1, 'Recommencer ?', NULL, 0),
(74, 55, 1, 'Recommencer ?', NULL, 0);
...
(34, 12, 2, 'Vous incarnez Mohammed, le compagnon dâ€™Emma. Au vu de son diagnostic, votre rÃ´le est dÃ©sormais de lui apporter un soutien quotidien pour lâ€™aider Ã  vivre avec sa maladie.', NULL, 'Etape 1', NULL),
...
--
ALTER TABLE `bouton`
  MODIFY `id_bouton` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=90;
--
-- AUTO_INCREMENT pour la table `page`
--
ALTER TABLE `page`
  MODIFY `id_page` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=67;
--
